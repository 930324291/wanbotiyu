...
import com.wj.baseutils.ui.fragment.VideoFragment;
...
public class MainActivity extends SimpleActivity {
    ...
    private VideoFragment matchFragment;
    ...
    private void initFragments(Bundle savedInstanceState) {
        ...
        matchFragment = (VideoFragment) getSupportFragmentManager().findFragmentByTag(VideoFragment.class.getSimpleName());
        if (matchFragment == null) {
            matchFragment = new VideoFragment();
        }
