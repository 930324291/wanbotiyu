            ...
            case HomeDataBean.DataBean.PostsBeanX.ITEM_NORMAL:
                ...
                helper.itemView.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        String url = "https://m.allwin368.com/Information/cont.html?id=10571&bmapp=1&pid=24";
                        if(!TextUtils.isEmpty(item.sourceUrl)){
                            url = item.sourceUrl;
                        }
                        Intent intent = new Intent(helper.itemView.getContext(), MWeb.class);
